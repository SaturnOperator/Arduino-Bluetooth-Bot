...
//MadgwickAHRS Algorithm that process the accelerometer data
Madgwick mpuRes;
...
void setup() {
  ...
  //Start the accelormeter data interpreter
  mpuRes.begin(25);
